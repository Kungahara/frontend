...
type Loan = { id: string; source: string; amount: string; borrowedOn: string; deadline: string; interestRate: string; createdBy: PersonSummary | null; updatedBy: PersonSummary | null };
