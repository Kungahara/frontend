...
type Sale = { id: string; productId: string; productName: string; categoryName: string; size: string; quantity: number; unitPrice: string; createdAt: string; createdBy: PersonSummary | null; updatedBy: PersonSummary | null };
