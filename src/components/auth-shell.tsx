...
export function AuthShellWithBackdrop({ mode, children, backdropSection = "home", backdropY = 0 }: { mode: "login" | "signup"; children: React.ReactNode; backdropSection?: string; backdropY?: number }) {
