...
type DocumentPhoto = { id: string; folderId: string | null; description: string; imageUrl: string; fileSize: number; mimeType: string; createdAt: string; createdBy: PersonSummary | null; updatedBy: PersonSummary | null };
...
export function DocumentsOverview() {
  ...
  async function deleteFolder() {
    ...
    try {
      ...
      if (activeFolder === deletingFolder.id) selectFolder("all-docs");
