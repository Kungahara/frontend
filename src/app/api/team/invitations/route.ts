...
export async function POST(request: Request) {
  ...
  const response = await backendRequest("team/invitations/", { method: "POST", headers: { Authorization: `Bearer ${access}`, "Content-Type": "application/json" }, body: JSON.stringify(body) });
